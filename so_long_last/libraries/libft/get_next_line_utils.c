...
/*   Updated: 2024/08/21 20:26:50 by cde-paiv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

size_t	ft_strlengl(char *s)
{
	size_t		i;
...
char	*ft_strjoingl(char *next_line, char *temp)
{
	char	*dest;
	...
	next_line_len = ft_strlengl(next_line);
	temp_len = ft_strlengl(temp);
